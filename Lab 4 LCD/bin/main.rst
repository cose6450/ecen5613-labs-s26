      ...
      000021                        436 	.ds	1
                                    ...
                                    479 ;--------------------------------------------------------
                                    480 	.area HOME    (CODE)
      002000                        481 __interrupt_vect:
      002000 02 20 34         [24]  482 	ljmp	__sdcc_gsinit_startup
                                    483 ;--------------------------------------------------------
      ...
      00208D 02 20 03         [24]  497 	ljmp	__sdcc_program_startup
                                    498 ;--------------------------------------------------------
                                    499 ; Home
                                    500 ;--------------------------------------------------------
                                    501 	.area HOME    (CODE)
                                    502 	.area HOME    (CODE)
      002003                        503 __sdcc_program_startup:
      002003 02 20 94         [24]  504 	ljmp	_main
                                    ...
                                    509 	.area CSEG    (CODE)
                                    510 ;------------------------------------------------------------
                                    511 ;Allocation info for local variables in function '_sdcc_external_startup'
                                    512 ;------------------------------------------------------------
                                    513 ;	src/main.c:28: int _sdcc_external_startup()
                                    514 ;	-----------------------------------------
                                    515 ;	 function _sdcc_external_startup
                                    516 ;	-----------------------------------------
      002090                        517 __sdcc_external_startup:
                           000007   518 	ar7 = 0x07
                           000006   519 	ar6 = 0x06
                           000005   520 	ar5 = 0x05
                           000004   521 	ar4 = 0x04
                           ...
                           000001   524 	ar1 = 0x01
                           000000   525 	ar0 = 0x00
                                    526 ;	src/main.c:31: return 0;
      002090 90 00 00         [24]  527 	mov	dptr,#0x0000
                                    528 ;	src/main.c:32: }
      002093 22               [24]  529 	ret
                                    530 ;------------------------------------------------------------
                                    531 ;Allocation info for local variables in function 'main'
                                    532 ;------------------------------------------------------------
                                    533 ;	src/main.c:37: void main()
                                    534 ;	-----------------------------------------
                                    535 ;	 function main
                                    536 ;	-----------------------------------------
      002094                        537 _main:
                                    538 ;	src/main.c:39: lcdinit();
      002094 12 29 0B         [24]  539 	lcall	_lcdinit
                                    540 ;	src/main.c:40: printf("40\r\n");
      002097 74 B0            [12]  541 	mov	a,#___str_0
      002099 C0 E0            [24]  542 	push	acc
      00209B 74 38            [12]  543 	mov	a,#(___str_0 >> 8)
      00209D C0 E0            [24]  544 	push	acc
      00209F 74 80            [12]  545 	mov	a,#0x80
      0020A1 C0 E0            [24]  546 	push	acc
      0020A3 12 2C A3         [24]  547 	lcall	_printf
      0020A6 15 81            [12]  548 	dec	sp
      0020A8 15 81            [12]  549 	dec	sp
      0020AA 15 81            [12]  550 	dec	sp
                                    551 ;	src/main.c:41: lcdputstr("HI");
      0020AC 90 38 B5         [24]  552 	mov	dptr,#___str_1
      0020AF 75 F0 80         [24]  553 	mov	b,#0x80
      0020B2 12 2A 54         [24]  554 	lcall	_lcdputstr
                                    555 ;	src/main.c:42: printf("42\r\n");
      0020B5 74 B8            [12]  556 	mov	a,#___str_2
      0020B7 C0 E0            [24]  557 	push	acc
      0020B9 74 38            [12]  558 	mov	a,#(___str_2 >> 8)
      0020BB C0 E0            [24]  559 	push	acc
      0020BD 74 80            [12]  560 	mov	a,#0x80
      0020BF C0 E0            [24]  561 	push	acc
      0020C1 12 2C A3         [24]  562 	lcall	_printf
      0020C4 15 81            [12]  563 	dec	sp
      0020C6 15 81            [12]  564 	dec	sp
      0020C8 15 81            [12]  565 	dec	sp
                                    566 ;	src/main.c:43: lcdgotoxy(1,0);
      0020CA 90 20 51         [24]  567 	mov	dptr,#_lcdgotoxy_PARM_2
      0020CD E4               [12]  568 	clr	a
      0020CE F0               [24]  569 	movx	@dptr,a
      0020CF 75 82 01         [24]  570 	mov	dpl,#0x01
      0020D2 12 2A 22         [24]  571 	lcall	_lcdgotoxy
                                    572 ;	src/main.c:44: printf("44\r\n");
      0020D5 74 BD            [12]  573 	mov	a,#___str_3
      0020D7 C0 E0            [24]  574 	push	acc
      0020D9 74 38            [12]  575 	mov	a,#(___str_3 >> 8)
      0020DB C0 E0            [24]  576 	push	acc
      0020DD 74 80            [12]  577 	mov	a,#0x80
      0020DF C0 E0            [24]  578 	push	acc
      0020E1 12 2C A3         [24]  579 	lcall	_printf
      0020E4 15 81            [12]  580 	dec	sp
      0020E6 15 81            [12]  581 	dec	sp
      0020E8 15 81            [12]  582 	dec	sp
                                    583 ;	src/main.c:45: lcdputstr("ESD");
      0020EA 90 38 C2         [24]  584 	mov	dptr,#___str_4
      0020ED 75 F0 80         [24]  585 	mov	b,#0x80
      0020F0 12 2A 54         [24]  586 	lcall	_lcdputstr
                                    587 ;	src/main.c:46: printf("46\r\n");
      0020F3 74 C6            [12]  588 	mov	a,#___str_5
      0020F5 C0 E0            [24]  589 	push	acc
      0020F7 74 38            [12]  590 	mov	a,#(___str_5 >> 8)
      0020F9 C0 E0            [24]  591 	push	acc
      0020FB 74 80            [12]  592 	mov	a,#0x80
      0020FD C0 E0            [24]  593 	push	acc
      0020FF 12 2C A3         [24]  594 	lcall	_printf
      002102 15 81            [12]  595 	dec	sp
      002104 15 81            [12]  596 	dec	sp
      002106 15 81            [12]  597 	dec	sp
      002108                        598 00103$:
                                    599 ;	src/main.c:48: }
      002108 80 FE            [24]  600 	sjmp	00103$
                                    601 	.area CSEG    (CODE)
                                    602 	.area CONST   (CODE)
                                    603 	.area CONST   (CODE)
      0038B0                        604 ___str_0:
      0038B0 34 30                  605 	.ascii "40"
      0038B2 0D                     606 	.db 0x0d
      0038B3 0A                     607 	.db 0x0a
      0038B4 00                     608 	.db 0x00
                                    609 	.area CSEG    (CODE)
                                    610 	.area CONST   (CODE)
      0038B5                        611 ___str_1:
      0038B5 48 49                  612 	.ascii "HI"
      0038B7 00                     613 	.db 0x00
                                    614 	.area CSEG    (CODE)
                                    615 	.area CONST   (CODE)
      0038B8                        616 ___str_2:
      0038B8 34 32                  617 	.ascii "42"
      0038BA 0D                     618 	.db 0x0d
      0038BB 0A                     619 	.db 0x0a
      0038BC 00                     620 	.db 0x00
                                    621 	.area CSEG    (CODE)
                                    622 	.area CONST   (CODE)
      0038BD                        623 ___str_3:
      0038BD 34 34                  624 	.ascii "44"
      0038BF 0D                     625 	.db 0x0d
      0038C0 0A                     626 	.db 0x0a
      0038C1 00                     627 	.db 0x00
                                    628 	.area CSEG    (CODE)
                                    629 	.area CONST   (CODE)
      0038C2                        630 ___str_4:
      0038C2 45 53 44               631 	.ascii "ESD"
      0038C5 00                     632 	.db 0x00
                                    633 	.area CSEG    (CODE)
                                    634 	.area CONST   (CODE)
      0038C6                        635 ___str_5:
      0038C6 34 36                  636 	.ascii "46"
      0038C8 0D                     637 	.db 0x0d
      0038C9 0A                     638 	.db 0x0a
      0038CA 00                     639 	.db 0x00
                                    640 	.area CSEG    (CODE)
                                    641 	.area XINIT   (CODE)

      ...
      00210A                        493 _putchar:
                           ...
                           000001   500 	ar1 = 0x01
                           000000   501 	ar0 = 0x00
      00210A AF 83            [24]  502 	mov	r7,dph
      00210C E5 82            [12]  503 	mov	a,dpl
      00210E 90 00 01         [24]  504 	mov	dptr,#_putchar_c_65536_3
      002111 F0               [24]  505 	movx	@dptr,a
      002112 EF               [12]  506 	mov	a,r7
      002113 A3               [24]  507 	inc	dptr
      002114 F0               [24]  508 	movx	@dptr,a
      ...
      002115                        510 00101$:
                                    ...
                                    512 ;	assignBit
      002115 10 99 02         [24]  513 	jbc	_TI,00114$
      002118 80 FB            [24]  514 	sjmp	00101$
      00211A                        515 00114$:
                                    516 ;	src/my_serial.c:16: SBUF = c; // load serial port with transmit value
      00211A 90 00 01         [24]  517 	mov	dptr,#_putchar_c_65536_3
      00211D E0               [24]  518 	movx	a,@dptr
      00211E FE               [12]  519 	mov	r6,a
      00211F A3               [24]  520 	inc	dptr
      002120 E0               [24]  521 	movx	a,@dptr
      002121 FF               [12]  522 	mov	r7,a
      002122 8E 99            [24]  523 	mov	_SBUF,r6
                                    524 ;	src/my_serial.c:17: return c;
      002124 8E 82            [24]  525 	mov	dpl,r6
      002126 8F 83            [24]  526 	mov	dph,r7
                                    527 ;	src/my_serial.c:18: }
      002128 22               [24]  528 	ret
                                    529 ;------------------------------------------------------------
      ...
      002129                        538 00101$:
                                    ...
                                    540 ;	assignBit
      002129 10 98 02         [24]  541 	jbc	_RI,00114$
      00212C 80 FB            [24]  542 	sjmp	00101$
      00212E                        543 00114$:
                                    544 ;	src/my_serial.c:25: return SBUF; // return character from SBUF
      00212E AE 99            [24]  545 	mov	r6,_SBUF
      002130 7F 00            [12]  546 	mov	r7,#0x00
      002132 8E 82            [24]  547 	mov	dpl,r6
      002134 8F 83            [24]  548 	mov	dph,r7
                                    549 ;	src/my_serial.c:26: }
      002136 22               [24]  550 	ret
                                    551 	.area CSEG    (CODE)
                                    552 	.area CONST   (CODE)
                                    553 	.area XINIT   (CODE)

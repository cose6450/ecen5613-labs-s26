      ...
      002207                        493 _putchar:
                           ...
                           000001   500 	ar1 = 0x01
                           000000   501 	ar0 = 0x00
      002207 AF 83            [24]  502 	mov	r7,dph
      002209 E5 82            [12]  503 	mov	a,dpl
      00220B 90 00 01         [24]  504 	mov	dptr,#_putchar_c_65536_3
      00220E F0               [24]  505 	movx	@dptr,a
      00220F EF               [12]  506 	mov	a,r7
      002210 A3               [24]  507 	inc	dptr
      002211 F0               [24]  508 	movx	@dptr,a
      ...
      002212                        510 00101$:
                                    ...
                                    512 ;	assignBit
      002212 10 99 02         [24]  513 	jbc	_TI,00114$
      002215 80 FB            [24]  514 	sjmp	00101$
      002217                        515 00114$:
                                    516 ;	src/my_serial.c:16: SBUF = c; // load serial port with transmit value
      002217 90 00 01         [24]  517 	mov	dptr,#_putchar_c_65536_3
      00221A E0               [24]  518 	movx	a,@dptr
      00221B FE               [12]  519 	mov	r6,a
      00221C A3               [24]  520 	inc	dptr
      00221D E0               [24]  521 	movx	a,@dptr
      00221E FF               [12]  522 	mov	r7,a
      00221F 8E 99            [24]  523 	mov	_SBUF,r6
                                    524 ;	src/my_serial.c:17: return c;
      002221 8E 82            [24]  525 	mov	dpl,r6
      002223 8F 83            [24]  526 	mov	dph,r7
                                    527 ;	src/my_serial.c:18: }
      002225 22               [24]  528 	ret
                                    529 ;------------------------------------------------------------
      ...
      002226                        538 00101$:
                                    ...
                                    540 ;	assignBit
      002226 10 98 02         [24]  541 	jbc	_RI,00114$
      002229 80 FB            [24]  542 	sjmp	00101$
      00222B                        543 00114$:
                                    544 ;	src/my_serial.c:25: return SBUF; // return character from SBUF
      00222B AE 99            [24]  545 	mov	r6,_SBUF
      00222D 7F 00            [12]  546 	mov	r7,#0x00
      00222F 8E 82            [24]  547 	mov	dpl,r6
      002231 8F 83            [24]  548 	mov	dph,r7
                                    549 ;	src/my_serial.c:26: }
      002233 22               [24]  550 	ret
                                    551 	.area CSEG    (CODE)
                                    552 	.area CONST   (CODE)
                                    553 	.area XINIT   (CODE)
